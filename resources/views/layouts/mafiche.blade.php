...
<div class="container">
    ...
    {{-- Supprime ou commente le dd après test --}}
    {{-- @dd($fiche) --}}
    ...
    @elseif ($fiche)
        ...
        @if ($remarque == 'accepte')
            <div class="card w-50">
                <span class="alert alert-success">Votre fiche a été validée avec succès</span>
                <div class="card-body">
                    ...
                    <p class="card-text text-xl">Besoins fonctionnels: {{ $fiche->besions_fonctionnels }}</p><br>
        ...
        @elseif ($remarque == 'en attente')
            <div class="alert alert-warning" role="alert">
                Votre fiche est en cours de validation.
            </div>
        ...
        @else
            <div class="alert alert-info" role="alert">
                Statut de la fiche inconnu ({{ $fiche->{"Remarque"} }}).
            </div>
        @endif
    @else
        <div class="alert alert-info" role="alert">
